...
public class FacebookOAuth2Test extends OAuth2Test {
    ...
    public void itShouldBePossibleToSignUp() throws InterruptedException {
        ...
        // Make sure the redirect from localhost to fb happened already (and that {@link HawkEyeUserServicePlugin#save()} gets called)
        Thread.sleep(3000);

        assertThat(browser.url()).isEqualTo("/#_=_");

        final FacebookAuthUser authUser = (FacebookAuthUser) (HawkEyeTestUserServicePlugin.getLastAuthUser());

...
import service.HawkEyeUserServicePlugin;
...
public abstract class OAuth2Test extends WithBrowser {
    ...
    protected FakeApplication provideFakeApplication() {
        ...
        additionalPlugins.add(HawkEyeTestUserServicePlugin.class.getName());
        ...
        return Helpers.fakeApplication(
                ...
                additionalPlugins,
                Collections.singletonList(HawkEyeUserServicePlugin.class.getName())
        );
    }
    ...
    public static class HawkEyeTestUserServicePlugin extends HawkEyeUserServicePlugin {

        private static AuthUser lastAuthUser;

        @Inject
        public HawkEyeTestUserServicePlugin(final Application app) {
            super(app);
        }
    ...
    public void resetLastAuthUser() {
        HawkEyeTestUserServicePlugin.resetLasAuthUser();
    }
